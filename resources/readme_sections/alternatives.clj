[:section#alternatives
 ...
 [:p "Even at this early stage of its life, Chlog can alleviate most of that labor. Keep the changelog as " [:code ".edn"] " data, and Chlog will take care of the html/markdown."]]