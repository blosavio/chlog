[:section#examples
 ...
 [:p [:a {:href "https://github.com/blosavio/chlog/blob/main/changelog.md"} "Changelog"] " for a changelog generator library."]

 [:p [:a {:href "https://github.com/blosavio/chlog/blob/main/resources/test_changelog/test_outputs/test_changelog.md"} "Changelog"] " for a fictitious library."]]